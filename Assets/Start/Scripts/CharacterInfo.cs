...
public class CharacterInfo : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        RaycastHit2D? hit = GetPositionOnTile(transform.position.x, transform.position.y);

        standingOnTile = hit.Value.collider.gameObject.GetComponent<OverlayTile>();
    ...
    private static RaycastHit2D? GetPositionOnTile(float x, float y)
    {
